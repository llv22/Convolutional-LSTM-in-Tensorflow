...
def train():
  ...
  with tf.Graph().as_default():
    with tf.variable_scope(tf.get_variable_scope()) as scope:
      ## about issue of "ValueError: Variable encode_1_conv/weights/Adam/ does not exist, or was not created with tf.get_variable(). Did you mean to set reuse=tf.AUTO_REUSE in VarScope?"
      # refer to https://github.com/tensorflow/tensorflow/issues/6220
      # make inputs
